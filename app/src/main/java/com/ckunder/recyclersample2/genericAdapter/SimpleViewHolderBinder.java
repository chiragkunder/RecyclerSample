 ...
 */
public abstract class SimpleViewHolderBinder implements ViewHolderBinder {
    ...
    public void bind(@NonNull RecyclerView.ViewHolder viewHolder, @NonNull final DisplayableItem<Object> item, @NonNull List<Object> payloads) {
