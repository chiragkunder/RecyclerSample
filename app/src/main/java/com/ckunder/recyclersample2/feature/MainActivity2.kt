...
class MainActivity2 : AppCompatActivity() {
    ...
    private val uiEntities: List<DisplayableItem<*>> = mutableListOf(
        ...
        TextViewEntity(text = "This is some text view entity 1").toDisplayableItem(R.layout.item_text),
        ...
        GroupViewEntity(
            displayableItemList = listOf(
                ...
                TextViewEntity(text = "GROUPED: This is some text view entity").toDisplayableItem(R.layout.item_text),
        ...
        TextViewEntity(text = "This is some text view entity 2").toDisplayableItem(R.layout.item_text),
